def get_training_data_distinct_letters(num_distinct_letters, num_samples, embeddings, distinct_letters_dict, all_rom_token_indices):

    # Fetch indices for tokens that contain the specified number of distinct letters
    positive_indices = distinct_letters_dict[num_distinct_letters]

    # Fetch indices for tokens that don't contain the specified number of distinct letters
