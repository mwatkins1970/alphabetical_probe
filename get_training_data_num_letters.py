def get_training_data_num_letters(num_letters, num_samples, embeddings, token_length_dict, all_rom_token_indices):

    # Fetch indices for tokens that contain the specified number of letters
    positive_indices = token_length_dict[num_letters]
